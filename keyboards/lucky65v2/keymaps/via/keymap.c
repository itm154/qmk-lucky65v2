...
enum layers { _LB = 0, _LF, _LS, _LM, _LMF, _LMS };

#define RGB_HSV_MAX 7
static uint8_t rgb_hsvs[7][3] = {
    {HSV_RED}, {HSV_YELLOW}, {HSV_GREEN}, {HSV_CYAN}, {HSV_BLUE}, {HSV_PINK}, {HSV_WHITE},
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_LB] = LAYOUT( /* Base */
        KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,    KC_EQL,    KC_BSPC,    KC_INS,KC_MUTE,
...
const uint8_t    f1_12_keycode[]   = {KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12};
        ...
        case RGB_HUI:
            if (record->event.pressed) {
                ...
                if ((now_mode_one == 6) || (now_mode_one == 13) || (now_mode_one == 15) || (now_mode_one == 16) || (now_mode_one == 25) || (now_mode_one == 26) || (now_mode_one == 34)) {
                    ...
                    rgb_matrix_sethsv(rgb_hsvs[confinfo.rgb_hsv_index][0], rgb_hsvs[confinfo.rgb_hsv_index][1], rgb_matrix_get_val());
                } else {
